...
function requirePerfetto_version () {
	...
	perfetto_version.VERSION = "v37.0-c4417a6dd";
	perfetto_version.SCM_REVISION = "c4417a6dd11f3db31a702dba1e3f0b674e90c173";
...
function requireTraceconv () {
	...
	selfWorker.onmessage = (msg) => {
	    ...
	    (0, logging_1.setErrorHandler)((err) => forwardError(err));
	    const args = msg.data;
