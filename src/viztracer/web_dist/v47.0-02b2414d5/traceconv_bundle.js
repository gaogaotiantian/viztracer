...
function requirePerfetto_version () {
	...
	perfetto_version.VERSION = "v47.0-02b2414d5";
	perfetto_version.SCM_REVISION = "02b2414d5cefce49f68cd71de96eac5fe793af44";
...
function requireConversion_jobs () {
	...
	// See the License for the specific language governing permissions and
	// limitations under the License.
	Object.defineProperty(conversion_jobs, "__esModule", { value: true });
	conversion_jobs.ConversionJobStatus = void 0;
	var ConversionJobStatus;
	(function (ConversionJobStatus) {
	    ConversionJobStatus["InProgress"] = "InProgress";
	    ConversionJobStatus["NotRunning"] = "NotRunning";
	})(ConversionJobStatus || (conversion_jobs.ConversionJobStatus = ConversionJobStatus = {}));
...
function requireTraceconv () {
	...
	async function ConvertTraceAndDownload(trace, format, truncate) {
	    ...
	    updateJobStatus(jobName, conversion_jobs_1.ConversionJobStatus.InProgress);
	    ...
	    try {
	        ...
	        updateJobStatus(jobName, conversion_jobs_1.ConversionJobStatus.NotRunning);
	    }
	}
