...
colors = ['#e6194B', '#3cb44b', '#ffe119', '#4363d8', '#f58231', '#42d4f4', '#f032e6', '#bfef45', '#fabed4', '#469990', '#dcbeff', '#9A6324', '#fffac8', '#aaffc3', '#808000', '#ffd8b1'] 
...
def snap_tree_node_html(node, parent_entry, parent_exit):
    ...
    ret = '<div style="left:{}%;width:{}%;" class="func-container">'.format(left*100, width*100)
    ret +='<div style="background-color:{};" class="func-block">{}</div>'.format(string_to_color(node.function_name), html.escape(node.function_name)) 
